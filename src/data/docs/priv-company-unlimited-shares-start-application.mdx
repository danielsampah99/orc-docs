...
** Select: Private Company Unlimited by Shares**
...
**Tick the checkbox: "I have read and understood" Click the "Proceed" button.**
...
**Tick the checkbox: "I have all relevant documents" Click the "Proceed" button.**
...
**After choosing, click the "Start Application" button.**
![Setp 6:|2000X1238](/priv-limited6.png)

###  Proceed with your Application by doing ***Name Availability Check***