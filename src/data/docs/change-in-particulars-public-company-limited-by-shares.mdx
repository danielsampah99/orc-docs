# Change in Particulars for Public Company Limited by Shares

## Overview

Users can update the registered particulars of a Public Company Limited by Shares entity. This document describes the step-by-step flow in the portal for submitting changes to business particulars.
...
Click **Details** on the Public Company Limited by Shares entry you want to change. This opens a preview of all registered information for that entity.

![Dashboard screenshot](/publimited1.png)
...
![Dashboard screenshot](/publimited2.png)

### 6. Start a new transaction

Click **New Change Transaction**. You'll be prompted to select which particulars you want to change.

![Dashboard screenshot](/publimited3.png)

### 7. Select the particulars to change

Particulars for a Public Company Limited by Shares entity are grouped into **six** categories:
...
![New transaction](/publimited4.png)
...
![New transaction](/publimited5.png)
...
![New transaction](/publimited6.png)
...
![New transaction](/publimited7.png)
