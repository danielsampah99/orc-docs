# Change in Particulars for Partnership

## Overview

Users can update the registered particulars of a Partnership entity. This document describes the step-by-step flow in the portal for submitting changes to business particulars.
...
Click **Details** on the Partnership entry you want to change. This opens a preview of all registered information for that entity.

![Dashboard screenshot](/partner1.png)
...
![Dashboard screenshot](/partner2.png)

### 6. Start a new transaction

Click **New Change Transaction**. You'll be prompted to select which particulars you want to change.

![Dashboard screenshot](/partner3.png)

### 7. Select the particulars to change

Particulars for a Partnership entity are grouped into **six** categories:

- Partner Details
- Address Details
- Contact Details
- Officer Details
- Charges on Partnership Assets
- Partnership Deed

![New transaction](/partner4.png)
