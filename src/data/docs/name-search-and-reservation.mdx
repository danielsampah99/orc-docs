...
Once a business name has been confirmed as available, clicking the "Reserve This Name" button opens a form titled "**New Business Name**". This form collects the necessary details required to complete the name reservation process.

![New Business Name Reservation Form|2000x1140](/name-search5.png)
...
- Input Field Label: "Entity Type *"  
  ...
  - Input Type: Dropdown  
  - Purpose: Select the legal structure of user’s business (e.g. Privatie Company Limited by Shares).
...
Clicking the "Continue" button redirects the user to a page displaying all business names they have reserved and their details.
