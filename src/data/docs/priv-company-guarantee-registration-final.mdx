...
After successful payment and verification, the newly registered entity appears in the user's list of drafts, with a status of **Pending Verification**.
After successful verification the status updates to **Pending Approval**.

![Registered Entities List|2000x1238](/guarantee38.png)

When the entity is approved, it is now listed under the users's registered entities with a status of **Active**.

![Registered Entities List|2000x1238](/guarantee39.png)
