# Change in Particulars for Private Company Unlimited by Shares

## Overview

Users can update the registered particulars of a Private Company Unlimited by Shares entity. This document describes the step-by-step flow in the portal for submitting changes to business particulars.
...
Click **Details** on the Private Company Unlimited by Shares entry you want to change. This opens a preview of all registered information for that entity.

![Dashboard screenshot](/privunlimited1.png)
...
![Dashboard screenshot](/privunlimited2.png)

### 6. Start a new transaction

Click **New Change Transaction**. You'll be prompted to select which particulars you want to change.

![Dashboard screenshot](/privunlimited3.png)

### 7. Select the particulars to change

Particulars for a Private Company Unlimited by Shares entity are grouped into **six** categories:
...
![New transaction](/privunlimited7.png)
...
![New transaction](/privunlimited4.png)
...
![New transaction](/privunlimited5.png)
...
![New transaction](/privunlimited6.png)
