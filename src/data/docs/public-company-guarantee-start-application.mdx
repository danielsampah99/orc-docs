...
![Private Company Limited by Guarantee Start Application|2000x1238](/guar1.png)

- **Start application**: Click the "Start application" button to begin the registration process for a Public Company Limited by Guarantee.
...
- **Fees:**
  ...
  # Public Company Limited By Guarantee – Registration Instructions

## Overview
A **Public Company Limited by Guarantee** is a company which has the liability of its members limited to an amount that the members may respectively undertake to contribute to the assets of the company in the event of it being wound up. Its a public company by reason of it not having a limit on its membership and as defined by its constitution. Example: churches, social enterprises, clubs, associations.
...
![Basic Registration Requirements|2000x1238](/guar4.png)
...
![Basic Registration Requirements|2000x1238](/guar5.png)
...
![Service Type Selection|2000x1238](/guar6.png)
