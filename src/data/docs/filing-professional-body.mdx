...
Click **Details** on the Professional Body entity you want to create a new filing for. This opens a preview of all registered information for that entity.

![Dashboard screenshot](/probodyfiling1.png) 

### 5. Locate the **Filing** option

On the right-hand menu, click **Filing** to start a new filing.

![Dashboard screenshot](/probodyfiling2.png)

### 6. Start new filing

Click **New Filing**. 

![Dashboard screenshot](/probodyfiling3.png)
...
![Dashboard screenshot](/probodyfiling4.png)
...
![Dashboard screenshot](/probodyfiling5.png)
![Dashboard screenshot](/probodyfiling6.png)
