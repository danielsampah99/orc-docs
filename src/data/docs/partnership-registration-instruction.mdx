...
- Click on "I Have Paid" upon successful payment and verification to be redirected to the entity location.

![Start Application|2000X1238](/paid9.png)

![Start Application|2000X1238](/final.png)

After verification is completed via email, the entity's status updates to **Pending Approval**.

![Start Application|2000X1238](/final1.png)

Once approval is complete the entity leaves the drafts and now appears under the registered entities with an **Active** status.

![Start Application|2000X1238](/final2.png)