# Change in Particulars for Professional Body

## Overview

Users can update the registered particulars of a Professional Body entity. This document describes the step-by-step flow in the portal for submitting changes to business particulars.
...
Click **Details** on the Professional Body entry you want to change. This opens a preview of all registered information for that entity.

![Dashboard screenshot](/probody1.png)
