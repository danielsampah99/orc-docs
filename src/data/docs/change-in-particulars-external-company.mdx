# Change in Particulars for External Company

## Overview

Users can update the registered particulars of a External Company entity. This document describes the step-by-step flow in the portal for submitting changes to business particulars.
...
Click **Details** on the External Company entry you want to change. This opens a preview of all registered information for that entity.

![Dashboard screenshot](/ec1.png)
...
![New transaction](/ec4.png)


### 8. Making the necessary updates

You can tick one or more checkboxes on each category at a time to change multiple sections in a single submission, *except* **Officer Details** and **Capital Amount**, where you can only tick one box at a time.
After selecting the categories you want to change, click **Change** and fill in the updated fields with the new information.

![New transaction](/ec5.png)
...
![New transaction](/ec7.png)

![New transaction](/ec8.png)
