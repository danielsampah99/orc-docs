# Change in Particulars for Public Company Unimited by Shares

## Overview

Users can update the registered particulars of a Public Company Unimited by Shares entity. This document describes the step-by-step flow in the portal for submitting changes to business particulars.
...
Click **Details** on the Public Company Unimited by Shares entry you want to change. This opens a preview of all registered information for that entity.
...
Particulars for a Public Company Unimited by Shares entity are grouped into **six** categories:
