# Change in Particulars for Public Company Unlimited by Shares

## Overview

Users can update the registered particulars of a Public Company Unlimited by Shares entity. This document describes the step-by-step flow in the portal for submitting changes to business particulars.
...
Click **Details** on the Public Company Unlimited by Shares entry you want to change. This opens a preview of all registered information for that entity.

![Dashboard screenshot](/puc1.png)
...
![New transaction](/puc7.png)

![New transaction](/puc8.png)
