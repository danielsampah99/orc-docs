# Change in Particulars for a Corporate Business Name

## Overview

Users can update the registered particulars of a Corporate Business Name entity. This document describes the step-by-step flow in the portal for submitting changes to business particulars.
...
Click **Details** on the Corporate Business Name entry you want to change. This opens a preview of all registered information for that entity.

![Dashboard screenshot](/corpchange1.png)
...
![New transaction](/corpchange4.png)
...
![New transaction](/corpchange5.png)
...
![New transaction](/corpchange6.png)
...
![New transaction](/corpchange7.png)
